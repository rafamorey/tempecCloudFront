...
// div temp
  ...
  const inputStatus = document.createElement('img')
  inputStatus.setAttribute("id", "statusDeviceButton")
  // inputStatus.setAttribute("value", "Status")
  // inputStatus.setAttribute("type", "Button")
  inputStatus.classList.add('deviceimgButton')
  inputStatus.setAttribute("src", "../icons/bote-de-basura.png")
  ...
  const imgConf = document.createElement('img')
  imgConf.classList.add('deviceimgButton')
  imgConf.setAttribute("src", "../icons/bote-de-basura.png") 
